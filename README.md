...
- OpenTelemetry SDK·OTLP protobuf와 bounded worker telemetry adapter
...
- [x] worker Attempt·Model/Tool OTel span과 비차단 로컬 OTLP 전송
- [ ] API→queue→worker의 전체 Run trace context 연결
